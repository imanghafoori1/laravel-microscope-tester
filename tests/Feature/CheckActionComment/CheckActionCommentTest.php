...
class CheckActionCommentTest extends TestCase
{
    ...
    public function test_adds_missing_comment()
    {
        ...
        $this->artisan('check:action_comments')->expectsQuestion('Add route definition into the: App\MyController', true)->expectsOutputToContain('Commentify Route Actions...')->run();

        $this->assertEquals(file_get_contents(__DIR__.'/CheckActionCommentStubs/expected.stub'), file_get_contents($this->tmpFileUnderTest()));
    }
