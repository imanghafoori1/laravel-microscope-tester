...
class FixNamespaceCommandTest extends TestCase
{
    ...
    public function it_fixes_namespaces_in_php_files()
    {
        ...
        $this->artisan('check:psr4')
            ->expectsConfirmation("Do you want to change it to: <fg=blue>Models</>", 'yes')
            ->expectsConfirmation("Do you want to update reference to the old namespace?", 'yes')
            ->expectsConfirmation("Do you want to change it to: <fg=blue>App\TestNamespaceFixer\SubDir</>", 'yes')
            ->expectsConfirmation("Do you want to change it to: <fg=blue>App\TestNamespaceFixer</>", 'yes')
            ->expectsConfirmation("Do you want to change it to: <fg=blue>App\TestNamespaceFixer</>", 'yes')
